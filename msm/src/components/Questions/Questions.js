...
const Questions = () => {
  ...
  const getContactInfo=(Name, birthDate, Gender, Phone, martialStatus, childrenNo, professionalStatus)=>{
  ...
  const complete=(level, MSM)=>{
    ...
    const Patient={ Name, birthDate, Gender, Phone, martialStatus, childrenNo, professionalStatus,
